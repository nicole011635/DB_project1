...
?>				</div>
			...
			<form action="4_2productInfor.php" method="post">
				...
				<div class="list-group-item iList" id="list1" style="display: none;">
				...
				<div class="list-group-item iList">
					...
					<h6 class="list-group-item-heading"><font><font>
						...
						<input type="submit" name="name" value="沐浴乳" class="sList">
				...
				<div class="list-group-item iList">
					...
					<h6 class="list-group-item-heading"><font><font>
						...
						<input type="submit" name="name" value="洗髮精液體皂" class="sList">
				...
				<div class="list-group-item iList">
					...
					<h6 class="list-group-item-heading"><font><font>
						...
						<input type="submit" name="name" value="美白保養系列" class="sList">
				...
				<div class="list-group-item iList">
					...
					<h6 class="list-group-item-heading"><font><font>
						...
						<input type="submit" name="name" value="寵愛寵物皂" class="sList">
				...
				<div class="list-group-item iList">
					...
					<h6 class="list-group-item-heading"><font><font>
						...
						<input type="submit" name="name" value="代製母乳皂" class="sList">
				...
				<div class="list-group-item iList">
					...
					<h6 class="list-group-item-heading"><font><font>
						...
						<input type="submit" name="name" value="個人膚質客製手工皂" class="sList">
		...
		<div class="col-md-10">
			...
			<ul class="breadcrumb">
				...
				<li>
					...
					<a href="#">表單下載</a> <span class="divider"></span>
			...
			<div >
				...
				<a href="#">
					...
					<input type="button" class="btn btn-success" value="下載">
			...
			<div>
				...
				<img src="http://pic.pimg.tw/feity/1380383531-1598501044.jpg?v=1380383532"

				alt="表單範本" width="700px" style="margin-left: 80px;margin-right: 80px;">
