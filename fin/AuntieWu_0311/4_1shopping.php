		...
		<div class="col-md-10">
			...
			<ul class="breadcrumb">
				...
				<li>
					...
					<a href="4_1shopping.php">洗顏沐浴皂</a> <span class="divider"></span>
...
$sql="SELECT `sId`, `sName` ,`sCharge`, `sPic` FROM `soap` ";
...
$sql='SELECT * FROM `soap` WHERE `sClass`= '.$class ;
	...
	while($row=mysqli_fetch_array($result)){
		...
		echo '<div class="col-md-4">
				...
				<div class="thumbnail">
					...
					<a href="4_2productInfor.php">

						<img alt="Product Image" src="pic/'.$row['sPic'].'" >

						<button type="submit" name="name" class="sList" value="'.$row['sName'].'">查看詳細</button>
		...
		/*	if ($result=mysqli_query($con,$sText)){
			...
			$row=mysqli_fetch_array($result);
				...
				echo "<p>error</p>";*/
							...
							echo "<label>".$row['sName']."</label><br>";

							echo "<label>售價：$ ".$row['sCharge']."</label>";
...
?>
						...
						<form action="addCart.php" method="post">
							...
							<label style="font-size:small">數量:</label>

							<input type="text" size="1px" name="number" value="1"><br>

							<button type="submit" class="btn btn-xs btn-default active" value="<?php echo $row['sId'];?>" name="sId"

							<!--onclick="alert('請先登入會員帳號!');"
